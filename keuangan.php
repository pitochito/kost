...
<div class="pb-24">
    ...
    <div class="bg-white p-4 md:p-5 rounded-xl shadow-sm border border-gray-200 mb-6">
        ...
        <form action="keuangan.php" method="GET" class="bg-gray-50 p-4 rounded-lg border border-gray-200 mb-6">
            <div class="flex flex-col md:flex-row gap-4 md:items-end">
                ...
                <div class="w-full md:w-auto">
                    ...
                    <select name="sum_tipe" id="sum_tipe" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-blue-500 bg-white text-sm" onchange="toggleDateSum()">
                ...
                <div id="sum_wrap_bulan" class="w-full md:w-auto <?= $sum_tipe == 'bulan' ? '' : 'hidden' ?>">
                    <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Pilih Bulan</label>
                    <input type="month" name="sum_bulan" value="<?= $sum_bulan ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-blue-500 bg-white text-sm">
                </div>
                
                <div id="sum_wrap_rentang" class="w-full md:w-auto grid grid-cols-2 md:flex md:flex-row gap-2 <?= $sum_tipe == 'rentang' ? '' : 'hidden' ?>">
                    <div class="w-full">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Dari</label>
                        <input type="date" name="sum_start" value="<?= $sum_start ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-blue-500 bg-white text-sm">
                    </div>
                    <div class="w-full">
                        <label class="block text-xs font-bold text-gray-500 uppercase tracking-wider mb-1">Sampai</label>
                        <input type="date" name="sum_end" value="<?= $sum_end ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-blue-500 bg-white text-sm">
                    </div>
                </div>
                
                <button type="submit" class="w-full md:w-auto bg-blue-600 hover:bg-blue-700 text-white px-6 py-2 rounded font-bold transition-colors shadow-sm whitespace-nowrap mt-2 md:mt-0">Lihat Ringkasan</button>
            </div>
        </form>
    ...
    <div id="section_pemasukan" class="bg-white rounded-lg shadow-sm border border-gray-200 mb-8 transition-all scroll-mt-20">
        ...
        <div id="wrapper_pemasukan" class="<?= $show_in ? 'block' : 'hidden' ?>">
            <form action="keuangan.php" method="GET" class="p-4 md:p-5 border-b border-gray-200 bg-white">
                <div class="flex flex-col md:flex-row flex-wrap gap-4 md:items-end">
                    ...
                    <div id="in_wrap_bulan" class="w-full md:w-auto <?= $in_tipe == 'bulan' ? '' : 'hidden' ?>">
                    ...
                    <div id="in_wrap_rentang" class="w-full md:w-auto grid grid-cols-2 md:flex md:flex-row gap-2 <?= $in_tipe == 'rentang' ? '' : 'hidden' ?>">
                        <div class="w-full"><label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Dari</label><input type="date" name="in_start" value="<?= $in_start ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-green-500 text-sm bg-white"></div>
                        <div class="w-full"><label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Sampai</label><input type="date" name="in_end" value="<?= $in_end ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-green-500 text-sm bg-white"></div>
                    </div>
                    
                    <div class="w-full md:w-auto flex-1 md:min-w-[200px]">
                    ...
                    <div class="w-full grid grid-cols-2 gap-4 md:flex md:w-auto md:gap-4">
                        <div class="w-full">
                            <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Status</label>
                            <select name="in_status" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-green-500 text-sm bg-white">
                        ...
                        <div class="w-full">
                            ...
                            <select name="in_limit" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-green-500 text-sm bg-white">
                    ...
                    <button type="submit" class="w-full md:w-auto bg-green-600 text-white px-6 py-2 rounded font-bold text-sm shadow-sm hover:bg-green-700 whitespace-nowrap mt-2 md:mt-0">Filter Data</button>
                </div>
            </form>
        ...
        <div id="wrapper_pengeluaran" class="<?= $show_out ? 'block' : 'hidden' ?>">
            <form action="keuangan.php" method="GET" class="p-4 md:p-5 border-b border-gray-200 bg-white">
                <div class="flex flex-col md:flex-row flex-wrap gap-4 md:items-end">
                    ...
                    <div id="out_wrap_bulan" class="w-full md:w-auto <?= $out_tipe == 'bulan' ? '' : 'hidden' ?>">
                        <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Bulan</label>
                    ...
                    <div id="out_wrap_rentang" class="w-full md:w-auto grid grid-cols-2 md:flex md:flex-row gap-2 <?= $out_tipe == 'rentang' ? '' : 'hidden' ?>">
                        <div class="w-full"><label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Dari</label><input type="date" name="out_start" value="<?= $out_start ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-red-500 text-sm bg-white"></div>
                        <div class="w-full"><label class="block text-[10px] font-bold text-gray-500 uppercase mb-1">Sampai</label><input type="date" name="out_end" value="<?= $out_end ?>" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-red-500 text-sm bg-white"></div>
                    </div>
                    ...
                    <div class="w-full grid grid-cols-2 gap-4 md:flex md:w-auto md:gap-4">
                        <div class="w-full">
                            ...
                            <select name="out_kat" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-red-500 text-sm bg-white">
                        ...
                        <div class="w-full">
                            <label class="block text-[10px] font-bold text-gray-500 uppercase tracking-wider mb-1">Tampil</label>
                            <select name="out_limit" class="w-full border border-gray-300 px-3 py-2 rounded focus:ring-2 focus:ring-red-500 text-sm bg-white">
                    ...
                    <button type="submit" class="w-full md:w-auto bg-red-600 text-white px-6 py-2 rounded font-bold text-sm shadow-sm hover:bg-red-700 whitespace-nowrap mt-2 md:mt-0">Terapkan Filter</button>
                </div>
            </form>
    ...
    <div class="bg-white rounded-xl shadow-2xl w-full max-w-md mx-4 overflow-hidden">
        ...
        <form action="keuangan.php" method="POST" onsubmit="return validasiModalBayar(event)" class="p-6">
            ...
            <div class="mb-4">
                ...
                <input type="date" name="tanggal_bayar_baru" value="<?= date('Y-m-d') ?>" required class="w-full border border-gray-300 px-4 py-2 rounded focus:ring-2 focus:ring-green-500 focus:outline-none bg-white text-sm">
            </div>
            <div class="mb-6">
                <label class="block text-sm font-bold text-gray-700 mb-1">Nominal Pembayaran (Rp) <span class="text-red-500">*</span></label>
                <input type="number" name="nominal_bayar_baru" id="input_nominal_bayar" required min="1" class="w-full border border-gray-300 px-4 py-2 rounded focus:ring-2 focus:ring-green-500 focus:outline-none bg-white font-bold text-lg text-gray-800 shadow-sm">
            </div>
...
function toggleDateSum() {
    ...
    if(tipe === 'bulan') {
        document.getElementById('sum_wrap_bulan').classList.remove('hidden');
        document.getElementById('sum_wrap_rentang').classList.add('hidden');
    } else {
        document.getElementById('sum_wrap_bulan').classList.add('hidden');
        document.getElementById('sum_wrap_rentang').classList.remove('hidden');
    }
}
...
function toggleDateIn() {
    ...
    if(tipe === 'bulan') {
        document.getElementById('in_wrap_bulan').classList.remove('hidden');
        document.getElementById('in_wrap_rentang').classList.add('hidden');
    } else {
        document.getElementById('in_wrap_bulan').classList.add('hidden');
        document.getElementById('in_wrap_rentang').classList.remove('hidden');
    }
}
...
function toggleDateOut() {
    ...
    if(tipe === 'bulan') {
        document.getElementById('out_wrap_bulan').classList.remove('hidden');
        document.getElementById('out_wrap_rentang').classList.add('hidden');
    } else {
        document.getElementById('out_wrap_bulan').classList.add('hidden');
        document.getElementById('out_wrap_rentang').classList.remove('hidden');
    }
}
